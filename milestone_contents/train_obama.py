...
from model.utils_obama import save_dict_to_json
from model.model_fn_obama import model_fn
from model.training_obama import train_and_evaluate
...
if __name__ == '__main__':
    ...
    train_data_dir = os.path.join(data_dir, "train_spec")
    dev_data_dir = os.path.join(data_dir, "dev_spec")
